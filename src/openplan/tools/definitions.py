    ...
    t(
        ...
        outputSchema={
            ...
            "properties": {
                ...
                "patterns": {"anyOf": [{"type": "array"}, {"type": "null"}]},
                "total_project_types": {"anyOf": [{"type": "integer"}, {"type": "null"}]},
                "total_patterns": {"anyOf": [{"type": "integer"}, {"type": "null"}]},
                "cross_type_averages": {"anyOf": [{"type": "object"}, {"type": "null"}]},
                "estimation_by_type": {"anyOf": [{"type": "object"}, {"type": "null"}]},
                "goal_satisfied": {"anyOf": [{"type": "boolean"}, {"type": "null"}]},
                "project_complete": {"anyOf": [{"type": "boolean"}, {"type": "null"}]},
                "results": {"anyOf": [{"type": "array"}, {"type": "null"}]},
